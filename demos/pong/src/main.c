...
static void OnInit() {
    ...
    /* Ball */
    LinceTexture* ball_texture = LinceAppGetAsset(string_scoped_lit("ball"), string_scoped_lit("texture"));
    ...
    /* Score indicators */
    LinceTexture* score_numbers = LinceAppGetAsset(string_scoped_lit("text"), string_scoped_lit("texture"));
...
int main() {
    ...
    LinceAppSetConfigFile(string_scoped_lit("demos/pong/project.toml"));
    LinceRun();
