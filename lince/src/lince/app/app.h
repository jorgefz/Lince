...
typedef struct LinceApp{
    ...
    LinceBool memcheck;          ///< Enables memory checking, which appends a header to every allocation to keep track of memory usage and leaks.
...
* @param name String name of scene to load
*/
...
* @param name String name of scene to fetch
* @returns Scene with matching identifier, or NULL if not found
*/
